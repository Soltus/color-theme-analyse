...
setuptools.setup(
    ...
    data_files=[
        ...
        ('bin',['src/MMCQsc/src/browser/linux/HttpServer.exe.config','src/MMCQsc/src/browser/linux/HttpServer.pdb','src/MMCQsc/src/browser/linux/HttpServerLib.pdb','src/MMCQsc/src/browser/linux/TaskBar','src/MMCQsc/src/browser/linux/TaskBar.pdb']),
        ('bin/runtimes/win-x64/native',['src/MMCQsc/src/browser/linux/runtimes/win-x64/native/WebView2Loader.dll']),
