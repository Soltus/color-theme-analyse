...
setuptools.setup(
    ...
    extras_require={
        ...
        'dev':['wheel','twine','auto-py-to-exe>=2.16.0; platform_system == "Windows"','setuptools','setuptools_scm','setuptools_scm_git_archive'],
        'merge':['numpy>=1.21','pillow>=8.3','rich>=0.1','wheel','twine','auto-py-to-exe>=2.16.0; platform_system == "Windows"','setuptools','setuptools_scm','setuptools_scm_git_archive'],
    },
